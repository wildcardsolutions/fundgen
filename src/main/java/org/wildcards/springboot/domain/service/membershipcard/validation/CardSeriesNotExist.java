 ...
 *
 */
public class CardSeriesNotExist extends AbstractValidator {
	 ...
	 */
	public CardSeriesNotExist(StoredProcedureService storedProcedureService) {
	...
	protected void throwExceptionIfNotValidated(ParameterMap mapOfParameters) {
		System.out.println("CardSeriesNotExist");
		...
		if (registered) {
			throw new ValidationException("Card(s) in the series already registered.");
		}
	}
}
